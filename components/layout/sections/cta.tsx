      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-muted/50 to-muted p-16">
        ...
        <div className="relative flex flex-col items-center text-center gap-8">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tighter">
            Ready to Monitor Your Memory?
          </h2>
          <p className="text-xl text-muted-foreground max-w-2xl">
            Get real-time insights into your system's memory usage with our comprehensive monitoring dashboard.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <Link href="/dashboard">
              <RainbowButton className="gap-4">
                Launch Dashboard <MoveRight className="w-4 h-4 ml-2" />
              </RainbowButton>
            </Link>
          </div>
        </div>
